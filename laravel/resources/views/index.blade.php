...
<link rel="icon" type="image/x-icon" href="/twj-shop/dist/images/twj-shop/favicon-32x32.png">
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <script src="https://cdn.tailwindcss.com"></script>
</head>
<title>TWJ Shop</title>
<body>
<!-- component -->
...
<div x-data="{ cartOpen: false , isOpen: false }" class="bg-white">
        ...
        <div class="container mx-auto px-6 py-3">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-end w-full">
                    <div class="hidden sm:flex">
                        <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 transition duration-300">Register</button>
                        <button class="bg-white hover:bg-gray-200 text-gray-800 px-4 py-2 transition duration-300">Login</button>
                    </div>
            ...
            <nav :class="isOpen ? '' : 'hidden'" class="sm:flex sm:justify-center sm:items-center mt-4">
                ...
                <div class="mt-4 sm:hidden">
                    <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 mb-2 block w-full transition duration-300">Login</button>
                    <button class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 block w-full transition duration-300">Register</button>
                  </div>
            </nav>
    ...
    {{-- <footer class="bg-gray-200">
        <div class="container mx-auto px-6 py-3 flex justify-between items-center">
            <a href="#" class="text-xl font-bold text-gray-500 hover:text-gray-400">TWJ Shop</a>
    ...
    <div class="flex flex-wrap items-center md:justify-between justify-center">
      <div class="w-full md:w-4/12 px-4 mx-auto text-center">
        <div class="text-sm text-blueGray-500 font-semibold py-1">
          Copyright © <span id="get-current-year">2023</span><a href="https://www.creative-tim.com/product/notus-js" class="text-blueGray-500 hover:text-gray-800" target="_blank">
          <a href="https://teguhwaluyojati.github.io/" class="text-blueGray-500 hover:text-blueGray-800">TWJ Dev</a>.
        </div>
      </div>
    </div>
  </div>
